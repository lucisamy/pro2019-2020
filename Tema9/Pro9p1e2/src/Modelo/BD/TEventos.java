...
public class TEventos {
    ...
    public void insertar(Evento ev){
        try{
            ...
            ps.setDate(3, ev.getFecha());//transformar de localdate a sql date o usar date en la clase "Evento"??
            ps.setTime(4, ev.getHoraInicio());//transformar de Localtime a sql time
            ps.setTime(5, ev.getHoraFin());
